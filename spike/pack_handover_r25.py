"""회사 PC 갈음 꾸러미 r25 를 만든다 (10~25회차 누적).

    python3 spike/pack_handover_r25.py
...
def main() -> int:
    ...
    inner = ROOT / "out" / "round25" / "3_FILES_TO_OVERWRITE.zip"
