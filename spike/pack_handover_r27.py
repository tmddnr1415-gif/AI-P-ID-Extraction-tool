"""회사 PC 갈음 꾸러미 r27 를 만든다 (10~27회차 누적).

    python3 spike/pack_handover_r27.py
...
def main() -> int:
    ...
    inner = ROOT / "out" / "round27" / "3_FILES_TO_OVERWRITE.zip"
