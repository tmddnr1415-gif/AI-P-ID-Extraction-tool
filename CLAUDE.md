...
| 항목 | 9회차 기준선 | 10회차 | 11회차 |
| --- | --- | --- | --- |
| `fingerprint` | 91ba3e33 | 3a57b6b2 | **69ad281f** (움직인 칸은 밸브 144행의 `scope` 뿐) |
| 행 수 | 824 | **1029** | **1029** (불변) |
| Q'ty 합계 | 1595 | 1911 | 1911 |
| 등급 | 704 / 47 / 12 / 61 · SKIP 0 | **704 / 48 / 51 / 22 · SKIP 204** | 같음 |
| **정확도 — 축1 전량** | 99.2% / 84.1% | **99.3% / 70.5%** | 99.3% / 70.5% (불변) |
| **정확도 — 축2 SCT** (11회차 신설) | — | — | **99.2% / 86.8%** |
| 글리프 · Description F1 · 식별 가능성 · ④→② 전환율 | H4/M32 · 69.3 · 39.6% · 19.7% | **전부 불변** | 전부 불변 |
| 테스트 | 빠른 116 | 빠른 130 | **빠른 137 · UI 21 · slow 10** |
| 발주처 양식 행수 | 824 기준 | 885 / 76 / 23 | **667 / 66 / 22** (SCT 만 · CZF 25행은 양식 미수령) |
